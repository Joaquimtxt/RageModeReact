...
const Games = () => {
  return (
    ...
    >
      ...
      <div className="w-100 d-flex flex-column align-items-start justify-content-center bg-black">
        <SelectGame Titulo="Jogos de Luta" />
      </div>
      <Link
        to={"/AddGame"}
        className="text-decoration-none text-light btn btn-danger btn-lg align-self-center mt-3"
      >
        <i className="bi bi-plus-circle fs-5 me-2"></i> Adicionar um Game
      </Link>
    </div>
  );
};
