...
const LikePost = () => {
  ...
  return (
    <div >
        <button className={`rounded-5 ${styles.likeButton} d-flex align-items-center justify-content-center`}>
        ...
        <button className={`rounded-5 d-flex align-items-center justify-content-center text-light fs-4 ${styles.ActBtn}`} data-bs-toggle="modal" data-bs-target="#ShareModal">
